...
### A calm, read-only workspace

![Sigla light workspace rendering bilingual Markdown in a strictly read-only three-pane interface](docs/assets/screenshots/01-hero-light.png)

### Bilingual Markdown, built for dark mode

![Sigla dark theme rendering English and Chinese Markdown with a TypeScript code block](docs/assets/screenshots/02-dark-bilingual-reading.png)

### AI insights that return to the source

![Sigla AI reading map generated by DeepSeek with a central conclusion, four key points, and links back to exact source lines](docs/assets/screenshots/03-ai-evidence-anchors.png)

### Annotations ready for the next Agent

![Sigla accepted annotation feedback with a local feedback file ready to copy or return to an Agent](docs/assets/screenshots/04-annotation-feedback-handoff.png)
