...
<!-- 截图位 01：docs/assets/screenshots/01-hero-light.png — 明亮模式三栏界面与 AI 总结 -->
<!-- 截图位 02：docs/assets/screenshots/02-dark-bilingual-reading.png — 暗色模式、中英文字体、代码、表格与 Mermaid -->
<!-- 截图位 03：docs/assets/screenshots/03-ai-evidence-anchors.png — AI 总结与原文证据跳转 -->
<!-- 截图位 04：docs/assets/screenshots/04-annotation-feedback-handoff.png — 框选批注与 Agent 反馈交接 -->
<!-- 截图位 05：docs/assets/screenshots/05-codex-default-app-flow.png — Codex 与系统默认 Markdown 打开流程 -->

> 产品截图将在正式公开前补齐。当前私有预发布仓库已经为五张核心截图保留准确位置。
